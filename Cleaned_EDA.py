...
crime.to_csv('communitiescrime.csv')
...
crime4.to_csv('cleanedcommunitiescrime.csv')
EDA = ProfileReport(crime4, title = "Cleaned Crime Data")
EDA.to_file("CleanCrimeDataFull.html")